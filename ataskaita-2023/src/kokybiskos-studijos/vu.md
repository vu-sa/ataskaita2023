...
*Senato kolegijoje – Vanesa Ražinskytė*
...
- Universitetas įsipareigoja užtikrinti galimybę mokytis mažiausiai
...
*Nutarimas:* Patvirtintas Vilniaus universiteto studijų programų
...
Ataskaitiniu laikotarpiu vyko 9 nuotoliniai Centrinės rinkimų komisijos
...
*Studentų atstovė – Dominyka Goldbergaitė*
...
Kanados lietuvių E. ir V. Kadis vardinės stipendijos yra skiriamos
...
struktūrines žinias bei konceptus, reikalingus atstovauti. Ataskaitiniu
laikotarpiu studentų atstovai (-ės) rinko studentų (-čių) nuomonę
anketavimo, virtualių tikslinių grupių arba mišriuoju metodu, o surinkti
ir susisteminti duomenys buvo panaudoti ir pristatyti SPK posėdžių metu.

Šiemet skirtinguose VU KAP iš viso įvyko 435 posėdžiai, kurių pagrindinė
darbotvarkės tema visose pirmosios studijų pakopos SPK buvo
individualiosios studijos, o antrosios pakopos SPK – nuo studentų
nubyrėjimo mažinimo strategijų iki atsiskaitymo formų keitimo. Detaliau
su kiekvieno VU KAP SPK posėdžių statistika susipažinti galite žemiau:

| VU KAP        |      SPK posėdžių skaičius      |  Pagrindinės 3 nagrinėtos temos |
| ------------- | :-----------: | :---- |
| **Chemijos ir geomokslų fakultetas**      | 32 | 1. Individualiosios studijos <br> 2. Studijų dalykų aprašų korekcijos, tvirtinimas <br> 3. Tiriamojo darbo įvedimo į programą svarstymas  |
| **Ekonomikos ir verslo administravimo fakultetas**      | 18 | 1. Individualiosios studijos <br> 2. Studijų tinklelio išdėstymo koregavimas <br> 3. Studentų (-čių) grįžtamojo ryšio skatinimas |
| **Filologijos fakultetas**      | 72 | 1. Studijų programos pritaikymas studijoms vykdyti anglų kalba; <br> 2. Naujų pasirenkamųjų dalykų ruošimas, tvirtinimas <br> 3. Užsienio studentų (-čių) pritraukimas  |
| **Filosofijos fakultetas**      | 57 | 1. Studentų (-čių) grįžtamojo ryšio aptarimas <br> 2. Studijų dalykų aprašų korekcijos <br> 3. Baigiamųjų darbų temų, komisijų tvirtinimas  |
| **Fizikos fakultetas**      | 20 | 1. Individualiosios studijos <br> 2. Studijų tinklelio išdėstymo koregavimas <br> 3. Dėstytojų keitimų svarstymai  |
| **Gyvybės mokslų centras**      | 22 | 1. Individualiosios studijos <br> 2. Naujų dėstytojų pritraukimas <br> 3. Studijų dalykų kontaktinių valandų skaičiaus keitimas  |
| **Istorijos fakultetas**      | 15 | 1. Individualiosios studijos <br> 2. Naujų studijų modulių įvedimo svarstymas <br> 3. Studentų (-čių) individualiųjų studijų planų tvirtinimas  |
| **Kauno fakultetas**      | 34 | 1. Individualiosios studijos <br> 2. Baigiamųjų darbų klausimai <br> 3. Studijų tinklelio išdėstymo koregavimas  |
| **Komunikacijos fakultetas**      | 43 | 1. Individualiosios studijos <br> 2. Studijų tinklelio išdėstymo koregavimas <br> 3. Pasirenkamųjų dalykų pasiūlos didinimas  |
| **Matematikos ir informatikos fakultetas**      | 24 | 1. Individualiosios studijos <br> 2. Studijų dalykų aprašų naujinimas <br> 3. Studijų tinklelio išdėstymo koregavimas  |
| **Medicinos fakultetas**      | 11 | 1. Individualiosios studijos <br> 2. Vertinimo sistemų atskiruose studijų dalykuose koregavimas <br> 3. Rėmėjų studentų moksliniams darbams finansuoti paieška  |
| **Šiaulių akademija**      | 41 | 1. Individualiosios studijos <br> 2. Studijų tinklelio koregavimas <br> 3. Paskaitų filmavimo rinkodariniais tikslais svarstymas  |
| **Tarptautinių santykių ir politikos mokslų institutas**      | 9 | 1. Studijų programų tobulinimas atsižvelgianti į studentų (-čių) atsiliepimus <br> 2. Studentų (-čių) nubyrėjimo klausimas <br> 3. Atsiskaitymų formatų keitimai  |
| **Teisės fakultetas**      | 3 | 1. Individualiosios studijos <br> 2. Vertinimo sistemų tarp studijų dalykų suvienodinimas <br> 3. Studijų dalykų aprašų naujinimas  |
| **Verslo mokykla**      | 34 | 1. Individualiosios studijos <br> 2. Studijų dalykų aprašų naujinimas <br> 3. Didesnio užsienio studentų pritraukimo svarstymai  |
...
Ataskaitiniu laikotarpiu vyko 11 posėdžių, kurių metu buvo kalbama apie
studijų individualizavimo procesus, teikiamus dokumentus, susijusius su
studijomis ir kitais aktualiais klausimais, buvo svarstoma Studijų
programų rengimo, vykdymo ir tobulinimo tvarkos aprašas, Individualiųjų
studijų ir pasirenkamųjų dalykų (modulių) įgyvendinimo Vilniaus
universitete tvarkos aprašas, Tarpkryptinių studijų koncepcija, VU
Tarptautinių studentų pritraukimo priemonių įgyvendinimo planas, Kalbų
politikos gairės, diskutuota apie grįžtamojo ryšio studijų procese
skatinimą.
...
Darbo grupės veikla tęstinė, einamuoju metu yra suplanuoti patobulinimai
